...
console.log('The value of the introduction ', introduction);
...
let food = 'tacos';                 
console.log('The value of the food ', food);
...
console.log(`The value of ${petStatus}`);
...
console.log(`The value of ${result2}`);
